...
answer_agent = AssistantAgent(
    ...
    system_message=(
        ...
        "The summarized context is provided to you, for which you will generate the user friendly answerc to the user."
        "The user has no idea about the summarized content, so dont reveal any implicit info and just take credit for the answer without boasting."
